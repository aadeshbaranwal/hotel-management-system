                ...
                <div className="section-1-container mt-5">
                    ...
                    <div className="wrapper d-flex justify-content-center flex-wrap">
                        ...
                        <div className="section-1-content room-img-1">
                            <Link to="roomFilter/1"> <span className="btn-light btn-sm btn">SINGLE BED</span></Link>
                        </div>
                        <div className="section-1-content room-img-2">
                            <Link to="roomFilter/2"><span className="btn-light btn-sm btn">DOUBLE BED</span></Link>
                        </div>
                        <div className="section-1-content room-img-3">
                            <Link to="roomFilter/3"><span className="btn-light btn-sm btn">TRIPLE BED</span></Link>
                        </div>
                        <div className="section-1-content room-img-4">
                            <Link to="roomFilter/4"><span className="btn-light btn-sm btn">LUXURY ROOMS(4 Beds)</span></Link>
                        </div>
                    </div>
                </div>
            </section>
